...
- **Files covered:** `index.html` (course home) and `week-1.html` through `week-8.html` (the eight weekly module pages)
- **Date:** 2026-05-24
...
| 1.4.6 Contrast (Enhanced) | AAA | Mostly met. Body copy and headings clear 7:1; the terra cotta dark-section accent is AA (5.5:1), a brand-fixed value. |
| 1.4.11 Non-text Contrast | AA | Pass. Study-card borders use `#8C90A0` (3.2:1); focus rings clear 3:1 on both backgrounds. |
...
Palette: navy `#0B1530`, near-black `#060A18`, rust `#8B3A2E`, terra cotta `#C2734D`, gold `#C9A14A`, cream `#F5F1E8`, white `#FFFFFF`, border slate `#8C90A0`. Ratios use the WCAG relative-luminance formula; opacity values are alpha-composited over their background before measuring. All pages share this CSS, so one audit covers the set.
...
| Day-card heading, cream on navy card | `#F5F1E8` / `#0B1530` | 16.0:1 | 4.5 | AAA |
| Day-card label, gold on navy card | `#C9A14A` / `#0B1530` | 7.5:1 | 4.5 | AAA |
| Day-card body, cream at 78% on navy card | composited / `#0B1530` | 10.0:1 | 4.5 | AAA |
...
Automated and structural audit performed by Claude (Cowork), 2026-05-24. Pending sign-off and a live screen-reader pass by Dr. Sharilyn Rennie.
