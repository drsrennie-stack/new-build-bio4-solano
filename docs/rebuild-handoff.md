...
cns-brain.html, rebuilt to 14 sections (73 KB), verified clean. This page is slated to be split, so its content will be redistributed into new files.
...
- cns-brain.html will be retired once its content is moved.

Most content already exists in cns-brain.html and moves straight across. The roots (dorsal and ventral roots, rootlets, dorsal root ganglion) still need to be ADDED to the spinal cord sheet; they were dropped in the first rebuild.
