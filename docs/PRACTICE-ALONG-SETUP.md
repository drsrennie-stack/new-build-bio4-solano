...
- **Apple Pencil pressure not working on the case canvas** → confirm students are using Safari on iPad (not Chrome). Pointer events with pressure are best supported in Safari., Dr. Sharilyn Rennie
