...
3. **week-1.html**, the student's weekly home base. One card per topic, each with its Study Bar, plus the week's lab sprints, the spaced-recall deck, and the video overview. Link the course index to this page.

## What is wired now (pilot)

- `week-1.html` renders Study Bars for Foundations, The Cell, Tissues, and Integumentary.
