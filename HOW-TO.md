...
`canvas-enter.html`. One file, one card, one button. This is the front door
...
```html
<p><iframe src="https://drsrennie-stack.github.io/new-build-bio4-solano/canvas-enter.html?sec=tr-eve"
