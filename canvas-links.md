# Canvas links, plain and simple
Two ways to add each one. **External URL is easier** and needs no HTML.

**A. Module item, no HTML.** In the Canvas module, click **+**, choose
**External URL**, paste the URL, name it, and tick **Load in a new tab**.

**B. On a page.** Paste the HTML in the `</>` editor.

The `?sec=` part is the one thing worth not dropping. It bakes the section
into the page, which is what keeps Safari students from being asked to pick
their section every single visit.

---

## Class 1 &middot; Mon/Wed afternoon &middot; CRN 80650
**Course home** (put the portal here, or just this link)

```
https://drsrennie-stack.github.io/new-build-bio4-solano/welcome.html?sec=mw
```
HTML version:

```html
<p><a class="btn btn-primary" href="https://drsrennie-stack.github.io/new-build-bio4-solano/welcome.html?sec=mw"
   target="_blank" rel="noopener">Open BIO 004 &#8599;</a></p>
```
...
## Class 2 &middot; Tue/Thu morning &middot; CRN 80654
**Course home** (put the portal here, or just this link)

```
https://drsrennie-stack.github.io/new-build-bio4-solano/welcome.html?sec=tr-am
```
HTML version:

```html
<p><a class="btn btn-primary" href="https://drsrennie-stack.github.io/new-build-bio4-solano/welcome.html?sec=tr-am"
   target="_blank" rel="noopener">Open BIO 004 &#8599;</a></p>
```
...
## Class 3 &middot; Tue/Thu evening &middot; CRN 80655
**Course home** (put the portal here, or just this link)

```
https://drsrennie-stack.github.io/new-build-bio4-solano/welcome.html?sec=tr-eve
```
HTML version:

```html
<p><a class="btn btn-primary" href="https://drsrennie-stack.github.io/new-build-bio4-solano/welcome.html?sec=tr-eve"
   target="_blank" rel="noopener">Open BIO 004 &#8599;</a></p>
```
...
## The few that never change

```
Mastery OS     https://drsrennie-stack.github.io/new-build-bio4-solano/mastery-os-fall-2026.html
Recall Rx      https://drsrennie-stack.github.io/new-build-bio4-solano/bio004-spaced-recall.html
Course calendar https://drsrennie-stack.github.io/new-build-bio4-solano/bio004-course-calendar.html
Loops          https://drsrennie-stack.github.io/loops/
Digital Atlas  https://share.articulate.com/UOHEe3p6DmTC4nXuUTE02
Study With Me  https://drsrennie-stack.github.io/new-build-bio4-solano/study-session-signup.html
```
